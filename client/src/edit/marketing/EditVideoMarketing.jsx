...
const EditVideoMarketing = () => {
  ...
  const getVideoById = async () => {
    const response = await axios.get(`http://localhost:5000/videomarketing/${id}`);
  ...
  const updateVideo = async (e) => {
    ...
    try {
      await axios.patch(`http://localhost:5000/videomarketing/${id}`, formData, {
        headers: {
...
export default EditVideoMarketing;
