...
const EditModulSales = () => {
  ...
  const getModulById = async () => {
    const response = await axios.get(`http://localhost:5000/modulsales/${id}`);
  ...
  const updateModul = async (e) => {
    ...
    try {
      await axios.patch(`http://localhost:5000/modulsales/${id}`, formData, {
        headers: {
