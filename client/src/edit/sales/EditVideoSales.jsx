...
const EditVideoSales = () => {
  ...
  const getVideoById = async () => {
    const response = await axios.get(`http://localhost:5000/videosales/${id}`);
  ...
  const updateVideo = async (e) => {
    ...
    try {
      await axios.patch(`http://localhost:5000/videosales/${id}`, formData, {
        headers: {
